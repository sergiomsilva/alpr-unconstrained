    ...
    def test_pickle(self):
        ...
        def check():
            ...
            for protocol in range(pickle.HIGHEST_PROTOCOL):
                ...
                for key, val in list(datsp.__dict__.items()):
...
class _TestSlicingAssign(object):
    ...
    def test_set_slice(self):
        ...
        with suppress_warnings() as sup:
            ...
            assert_array_equal(A.todense(), B)
            A[1:5:2,0] = np.array(list(range(1,5,2)))[:,None]
            B[1:5:2,0] = np.array(list(range(1,5,2)))[:,None]
            assert_array_equal(A.todense(), B)
...
class TestLIL(sparse_test_class(minmax=False)):
    ...
    def test_inplace_ops(self):
        ...
        for op,(other,expected) in list(data.items()):
            result = A.copy()
