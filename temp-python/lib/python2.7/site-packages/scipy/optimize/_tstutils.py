...
_ORIGINAL_TESTS_DICTS = [dict(list(zip(_ORIGINAL_TESTS_KEYS, testcase))) for testcase in _ORIGINAL_TESTS]
...
_APS_TESTS_DICTS = [dict(list(zip(_APS_TESTS_KEYS, testcase))) for testcase in _APS_TESTS]
...
_COMPLEX_TESTS_DICTS = [dict(list(zip(_COMPLEX_TESTS_KEYS, testcase))) for testcase in _COMPLEX_TESTS]
